...
final class TimelineContentViewModel{
    private(set) var contents: [TimelineContent] = []
    ...
    func loadData() {
        ...
        contents.append(TimelineContent(id: 1,
                                        ...
                                        type: .photoMessage(photo: "timeline_profile_image_lu_photo1", message: "草莓兔最近移情别恋, 都好久不和我在一起玩了. 哼~生气."),
                                        likes: ["草莓🐰"]))
    }
}
